/* Generated by Cython 0.11.1 on Wed Apr 29 17:00:55 2009 */
...
const char *__pyx_modulename = "helloworld";

/* Implementation of helloworld */
static char __pyx_k_1[] = "Hello";
static PyObject *__pyx_kp_1;
static char __pyx_k_2[] = "World";
...
#endif
{
  ...
  /* "/home/moshev/Projects/mozyka/src/cython-hello-world/helloworld.pyx":1
 * print("Hello", "World")             # <<<<<<<<<<<<<<
 * 
 */
  __pyx_t_1 = PyTuple_New(2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__Pyx_PrintOne(((PyObject *)__pyx_t_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
